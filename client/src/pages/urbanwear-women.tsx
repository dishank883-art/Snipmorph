...
export default function UrbanWearWomen() {
  ...
  const { data: products = [], isLoading } = useQuery<Product[]>({
    queryKey: ['/api/products', { gender: 'women', search: debouncedSearch, sort: sortBy }],
    queryFn: async () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-3xl font-bold text-foreground" data-testid="page-title">Women's Collection</h1>
            </div>
