              ...
              <NavigationMenuList className="gap-x-6">
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <Link href="/urbanwear/products" className="text-gray-700 hover:text-gray-900 font-medium" data-testid="nav-products">
                      Our Products
                    </Link>
                  </NavigationMenuLink>
                </NavigationMenuItem>
              ...
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                ...
                <SheetContent side="right" className="w-80">
                  ...
                  <div className="space-y-4">
                    <Link href="/urbanwear/products" className="block py-3 text-gray-900 font-medium" onClick={() => setMobileMenuOpen(false)} data-testid="mobile-products">
                      Our Products
                    </Link>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              { name: "Hoodies & Sweatshirts", href: "/urbanwear/products", image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" },
              { name: "T-Shirts & Tops", href: "/urbanwear/products", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" },
              { name: "Pants & Joggers", href: "/urbanwear/products", image: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" },
              { name: "Dresses", href: "/urbanwear/products", image: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" },
              { name: "Activewear", href: "/urbanwear/products", image: "https://cdn.pixabay.com/photo/2014/12/25/20/52/runner-580055_1280.jpg?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" },
              { name: "Sustainable Basics", href: "/urbanwear/products", image: "https://cdn.pixabay.com/photo/2020/04/09/14/42/girls-5021801_1280.jpg?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" },
              { name: "Outerwear", href: "/urbanwear/products", image: "https://cdn.pixabay.com/photo/2021/09/13/07/08/man-6620481_1280.jpg?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" },
              { name: "Accessories", href: "/urbanwear/products", image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500" }
            ].map((category, index) => (
